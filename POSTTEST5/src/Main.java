...
public class Main {
    ...
    public static void main(String[] args) {
        int pilihan;
        do {
            System.out.println("\nSISTEM MANAJEMEN ABSENSI KARYAWAN (VERSI ABSTRAKSI)");
    ...
    static void tampilKaryawan() {
        ...
        System.out.println("\nDAFTAR KARYAWAN (IMPLEMENTASI ABSTRAKSI & INTERFACE");
        for (Karyawan k : daftarKaryawan) {
            k.tampilInfo("DATA DETAIL"); // Overloading
            k.tugasUtama();
            if (k instanceof IKerja) {
                IKerja kerja = (IKerja) k;
                kerja.mulaiKerja();
                kerja.selesaiKerja();
            }
            System.out.println("--------------------");
